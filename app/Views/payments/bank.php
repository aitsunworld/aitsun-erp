                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1"><?= lang(get_setting(company($user['id']),'language'),'Bank'); ?></h4>
                ...
                <div class="form-group col-md-6">
                  <label class=""><?= lang(get_setting(company($user['id']),'language'),'Payment Type'); ?></label>
                    <select class="form-control payment_type" name="payment_type" data-id="<?= $pmt->id; ?>" required>
                        ...
                        <option value="cheque" <?php if ($pmt->type=='cheque'){echo 'selected'; }?>><?= lang(get_setting(company($user['id']),'language'),'Cheque'); ?></option>
                        <option value="bank_transfer" <?php if ($pmt->type=='bank_transfer'){echo 'selected'; }?>><?= lang(get_setting(company($user['id']),'language'),'Bank Transfer'); ?></option>
                    </select>
                </div><!-- form-group -->
        ...
        <div class="row">
          ...
          <div class="col-md-12" >
            <div class="w-100 row">
                ...
                <div id="cheque_optionsaddd" class="d-none col-md-12">
                    <div id="chk_option_container">
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                ...
                <div id="bank_transfer_optionsaddd" class="d-none col-md-12">
                  <div class="row">
                    <div class="col-md-6">
                    <label><?= lang(get_setting(company($user['id']),'language'),'Reference Id'); ?></label>
     ...
     $(document).on('change', '.select_c_status', function(){
       ...
       var getid = $(this).attr("data-id");    
        ...
        $.ajax({
            ...
            success:function(result){
                if (statusname=='1') {
                    $('#'+getid+'rec_status').html(' <span class="bg-success rec_status" ><span class="m-auto"><?= lang(get_setting(company($user['id']),'language'),'Received'); ?></span></span>');
                }else{
                    $('#'+getid+'rec_status').html(' <span class="bg-danger rec_status" ><span class="m-auto"><?= lang(get_setting(company($user['id']),'language'),'Not Received'); ?></span></span>');
                }
