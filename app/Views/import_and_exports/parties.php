    ...
    <div class="aitsun-row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="ie_box d-flex">
                        <div class="m-auto ">
                          <a class=" btn btn-dark btn-sm download_complete " href="<?= base_url('import_and_export/export_parties'); ?>">
                            Export Parties
                          </a>
                        </div>
                    </div>
        ...
        <div class="col-xl-6 col-md-6">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="ie_box d-flex">
                        <form action="<?= base_url('import_and_export/import_parties');?>" class="submit_loader m-auto text-center spsec-validation" id="spsec-validation" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            <?= csrf_field(); ?>
                            ...
                            <div class="form-group position-relative mb-2">
                                ...
                                <div class="form-group">
                                    <button type="submit" name="import_csv" id="import_csv" class="btn btn-dark  btn-sm">Import Parties</button>
                                </div> 
                       </form>
