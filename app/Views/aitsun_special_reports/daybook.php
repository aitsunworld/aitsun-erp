        ...
        <div class="filter_bar">
            ...
            <form method="get" class="d-flex">
               ...
               <input type="date" name="from" class="form-control form-control-sm filter-control" title="From" placeholder="">
                ...
                <a class=" btn-outline-dark btn btn-sm" href="<?= base_url('special_reports/day-book') ?>"><?= langg(get_setting(company($user['id']),'language'),'Clear'); ?></a>
        ...
        <div class="aitsun_table w-100 pt-0">
            ...
            <table id="daybook_table" class="erp_table sortable">
                 <thead>
                    ...
                    <tr> 
                        <th class="sorticon"><?= langg(get_setting(company($user['id']),'language'),'Name'); ?></th>
