...
<div class="toolbar d-flex justify-content-between">
    ...
    <div class="d-flex">
        <button type="submit" class="aitsun-secondary-btn-topbar me-1 load_me_on_submit_click" name="draft">Draft</button>
        <button type="submit" class="aitsun-primary-btn-topbar load_me_on_submit_click"><i class="bx bx-check"></i> Publish</button>
    </div>
                        ...
                        <div  class="row web_pageeefro" id="featured_upload_form">
                            ...
                            <p id="p_text" >
                            	...
                            	<?php if ($po['featured'] !=''): ?>
                                   ...
                                   <img  src="<?= base_url(); ?>/public/images/posts/<?php if( $po['featured'] !=''){echo $po['featured']; }else{echo 'prod.png';} ?>" class="fe_img"  ondragstart="return false;">
                    ...
                    <div class="m-b-30">
                        <div  class="row web_pageeefro tumbimage" id="thumb_upload_form">
                            ...
                            <div id="p_text" class="d-flex m-auto justify-content-center">
	                            ...
	                            <?php $cthu=0; foreach (thumbnails_array($po['id']) as $pt): $cthu++; ?>
	                            	<span class="thbox">
                ...
                <div class="form-group">
                    <div class="input-box <?= (!empty($po['post_name'])) ? 'active' : '' ?>">
                        ...
                        <select class="input-1" id="post_name" name="post_name" required onfocus="setFocus(true)" onblur="setFocus(false)" onchange="setChange()">
                            ...
                            <option value="blog" <?php if ($po['post_name']=='blog'){echo "selected";} ?>>Blog</option>
                            <option value="project" <?php if ($po['post_name']=='project'){echo "selected";} ?> >Project</option>
                        </select>
                    </div>  
                </div>

                <div id="project_fileds" class="row <?php if ($po['post_name']!='project'){echo 'd-none'; }?> ">
                         ...
                         <a class="add_cat_btn"><span class="m-auto">+</span></a>
                            <div style="display: none;" id="catt_box" class="cat_container">
                                <div class="w-100 d-flex mt-2">
                                    ...
                                    <button id="add_new_category" type="button" class="aitsun-cat-btn">Add</button>
                                </div>
                            </div>
                    </div>
                </div>
