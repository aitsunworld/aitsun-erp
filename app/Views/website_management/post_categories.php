    ...
    <div class="row website_margin position-relative p-0">
        ...
        <div class="col-lg-12">
            ...
            <div class="toolbar_sidebar d-flex justify-content-between">
                <div>
                    <a href="javascript:void(0);" class="aitsun_table_export text-dark font-size-footer me-2" data-type="excel" data-table="#post_cat_table" data-filename="Post categories - <?= get_date_format(now_time($user['id']),'d M Y') ?>"> 
                        <span class="my-auto">Excel</span>
                    </a>
                    <a href="javascript:void(0);" class="aitsun_table_export text-dark font-size-footer me-2" data-type="csv" data-table="#post_cat_table" data-filename="Post categories - <?= get_date_format(now_time($user['id']),'d M Y') ?>"> 
                        <span class="my-auto">CSV</span>
                    </a>
                    <a href="javascript:void(0);" class="aitsun_table_export text-dark font-size-footer me-2" data-type="pdf" data-table="#post_cat_table" data-filename="Post categories - <?= get_date_format(now_time($user['id']),'d M Y') ?>"> 
        ...
        <div class="aitsun_table col-12 w-100 pt-2 pb-5">
            ...
            <table id="post_cat_table" class="erp_table">
             <thead>
              ...
              <tbody>
                 <?php $cii=0; foreach ($postcategories as $cs): $cii++; ?>
                     <tr>
