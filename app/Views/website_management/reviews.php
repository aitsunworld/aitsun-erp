    ...
    <div class="row website_margin position-relative p-0">
        ...
        <div class="col-lg-12">
            ...
            <div class="toolbar_sidebar d-flex justify-content-between">
                <div>
                    <a href="javascript:void(0);" class="aitsun_table_export text-dark font-size-footer me-2" data-type="excel" data-table="#post_cat_table" data-filename="Website reviews - <?= get_date_format(now_time($user['id']),'d M Y') ?>"> 
                        <span class="my-auto">Excel</span>
                    </a>
                    <a href="javascript:void(0);" class="aitsun_table_export text-dark font-size-footer me-2" data-type="csv" data-table="#post_cat_table" data-filename="Website reviews - <?= get_date_format(now_time($user['id']),'d M Y') ?>"> 
                        <span class="my-auto">CSV</span>
                    </a>
                    <a href="javascript:void(0);" class="aitsun_table_export text-dark font-size-footer me-2" data-type="pdf" data-table="#post_cat_table" data-filename="Website reviews - <?= get_date_format(now_time($user['id']),'d M Y') ?>"> 
        ...
        <div class="aitsun_table col-12 w-100 pt-2 pb-5">
            ...
            <table id="post_cat_table" class="erp_table">
             <thead>
              ...
              <tbody>
                <?php $cii=0; foreach ($reviews as $rv): $cii++; ?>
                    <tr>
                        <td>
                            <div class="d-flex">
                                
                                <div><img style="width: 40px;height: 40px;border-radius: 50%;
    object-fit: cover;border: 1px solid #920a36;" src="<?= base_url(); ?>/public/images/review/<?php if( $rv['profile_pic'] !=''){echo $rv['profile_pic']; }else{echo 'prod.png';} ?>"></div>
                                                    ...
                                                    <div class="row">
                                                       ...
                                                       <div class="form-group col-md-6 mb-2">
                                                        ...
                                                        <div class="form-group col-md-6 mb-2">
                                                            <label>Ratings</label>
                                                            <select class="form-select" required name="ratings">
                                                                <option value="1" <?php if ($rv['ratings']==1){ echo 'selected'; } ?> >1</option>
                                                                <option value="2" <?php if ($rv['ratings']==2){ echo 'selected'; } ?> >2</option>
                                                                <option value="3" <?php if ($rv['ratings']==3){ echo 'selected'; } ?> >3</option>
                                                                <option value="4" <?php if ($rv['ratings']==4){ echo 'selected'; } ?> >4</option>
                                                                <option value="5" <?php if ($rv['ratings']==5){ echo 'selected'; } ?> >5</option>
                                                            </select>
