    ...
    <div class="row  product-grid pb-3" style="">
        <div class="table_box pb-5">
            <table id="product_list_table" class="w-100">
                ...
                <tbody>
                    <?php $pi=0; foreach ($posts as $po): $pi++; ?>
                    <tr> 
                        ...
                        <td>
                            <div class="d-flex py-1">
                                ...
                                <?php if ($po['featured'] !=''): ?>
                                   <img onclick="location.href='<?= base_url('website_management/edit_post'); ?>/<?= $po['id']; ?>';" src="<?= base_url(); ?>/public/images/posts/<?php if( $po['featured'] !=''){echo $po['featured']; }else{echo 'prod.png';} ?>" class="href_loader card-img-top me-2 pro_featured " draggable="false" style="-moz-user-select: none; background-repeat: no-repeat, repeat;
                                    background-image: url('<?= base_url(); ?>/public/images/posts/<?php if( $po['featured'] !=''){echo $po['featured']; }else{echo 'prod.png';} ?>'), url('');
                                    ...
                                    <div class="my-auto w-100 pro_box">
                                        ...
                                        <p class="category_text d-flex justify-content-between mt-1">
                                         ...
                                         <span> 
                                            ...
                                            <small class="">
                                                <b class="<?= ($po['status']=='published') ? 'text-success' : 'text-aitsun-red' ?>"><?= $po['status']; ?></b> on <span class="text-dark"><?= aitsun_date_month_year($po['datetime']); ?></span>
                                            </small>
...
<td class="text-center"> 
    <div class="pro_box_details">
        <div>   
                <small class=" text-capitalize"><span><?= cat_name($po['category']); ?></span></small>
