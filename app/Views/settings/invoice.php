...
<div class="main_page_content">
    <div>
        <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12 row m-0" >
                        ...
                        <div class="col-md-3">
                            <div class="form-group col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <input type="checkbox" class="form-check-input" id="settings-check3" name="show_batch_no" value="1" <?php if (get_setting(company($user['id']),'show_batch_no') == '1') {echo 'checked';} ?>>
                           ...
                           <div class="form-group col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <input type="checkbox" class="form-check-input" id="settings-check4" name="show_price" value="1" <?php if (get_setting(company($user['id']),'show_price') == '1') {echo 'checked';} ?>>
                           ...
                           <div class="form-group col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="settings-check5" name="show_tax" value="1" <?php if (get_setting(company($user['id']),'show_tax') == '1') {echo 'checked';} ?>>
                           ...
                           <div class="form-group col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="settings-check6" name="show_discount" value="1" <?php if (get_setting(company($user['id']),'show_discount') == '1') {echo 'checked';} ?>>
                           ...
                           <div class="form-group col-md-6 mb-3">
                                <div class="form-check form-switch">
                                   <input type="checkbox" class="form-check-input" id="settings-check7" name="show_quantity" value="1" <?php if (get_setting(company($user['id']),'show_quantity') == '1') {echo 'checked';} ?>>
                       ...
                       <div class="form-group col-md-6 mb-3">
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="settings-check8" name="show_logo" value="1" <?php if (get_setting(company($user['id']),'show_logo') == '1') {echo 'checked';} ?>>
                       ...
                       <div class="form-group col-md-6 mb-3">
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="settings-check9" name="show_expiry_date" value="1" <?php if (get_setting(company($user['id']),'show_expiry_date') == '1') {echo 'checked';} ?>>
                      ...
                      <div class="col-md-3">
                        ...
                        <div class="form-group col-md-6 mb-3">
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="settings-check10" name="show_due_date" value="1" <?php if (get_setting(company($user['id']),'show_due_date') == '1') {echo 'checked';} ?>>
                       ...
                       <div class="form-group col-md-6 mb-3">
                            <div class="form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="settings-check11" name="show_head" value="1" <?php if (get_setting(company($user['id']),'show_head') == '1') {echo 'checked';} ?>>
                           ...
                           <div class="form-group col-md-6 mb-3">
                                <div class="form-check form-switch">
                                   <input type="checkbox" class="form-check-input" id="settings-check7" name="show_uom" value="1" <?php if (get_setting(company($user['id']),'show_uom') == '1') {echo 'checked';} ?>>
                           ...
                           <div class="form-group col-md-12 mb-3">
                                <div class="form-check form-switch">
                                   <input type="checkbox" class="form-check-input" id="settings-check16" name="show_hsncode_no" value="1" <?php if (get_setting(company($user['id']),'show_hsncode_no') == '1') {echo 'checked';} ?>>
                           ...
                           <div class="form-group col-md-12 mb-3">
                                <div class="form-check form-switch">
                                   <input type="checkbox" class="form-check-input" id="settings-check19" name="billing_style" value="1" <?php if (get_setting(company($user['id']),'billing_style') == '1') {echo 'checked';} ?>>
                           ...
                           <div class="form-group col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    <input type="checkbox" class="form-check-input" id="settings-check18" name="show_validity" value="1" <?php if (get_setting(company($user['id']),'show_validity') == '1') {echo 'checked';} ?>>
                            ...
                            <div class="form-group col-md-6 mb-3">
                                <div class="form-group col-md-12 mb-3">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" id="settings-check17" name="show_mrn_number" value="1" <?php if (get_setting(company($user['id']),'show_mrn_number') == '1') {echo 'checked';} ?>>
    ...
    <img src="<?= base_url('public/images/company_docs') ?>/<?php if(!empty($c_set['invoice_header'])){echo $c_set['invoice_header'];}else{echo 'alt.png';} ?>" class="my-auto py-2" style="max-height: 60px;">
   </div>
   ...
   <div class="col-md-12 d-md-flex form-group justify-content-between mb-3">
    ...
    <img src="<?= base_url('public/images/company_docs') ?>/<?php if(!empty($c_set['invoice_signature'])){echo $c_set['invoice_signature'];}else{echo 'alt.png';} ?>" class="my-auto py-2" style="max-height: 60px;">
   </div>
   ...
   <div class="col-md-12 d-md-flex form-group justify-content-between mb-3">
    ...
    <img src="<?= base_url('public/images/company_docs') ?>/<?php if(!empty($c_set['payslip_signature'])){echo $c_set['payslip_signature'];}else{echo 'alt.png';} ?>" class="my-auto py-2" style="max-height: 60px;">
   </div>
   ...
   <div class="col-md-12 d-md-flex form-group justify-content-between mb-3">
    ...
    <img src="<?= base_url('public/images/company_docs') ?>/<?php if(!empty($c_set['invoice_seal'])){echo $c_set['invoice_seal'];}else{echo 'alt.png';} ?>" class="my-auto py-2" style="max-height: 60px;">
   </div>
   ...
   <div class="col-md-12 d-md-flex form-group justify-content-between mb-3">
    ...
    <img src="<?= base_url('public/images/company_docs') ?>/<?php if(!empty($c_set['invoice_qr_code'])){echo $c_set['invoice_qr_code'];}else{echo 'alt.png';} ?>" class="my-auto py-2" style="max-height: 60px;">
   </div>
                      </div>
   ...
   <div class="form-group col-md-6 mb-3">
    ...
    <input type="number" class="form-control" name="tinnumber" value="<?= $c_set['tinnumber'] ?>">
                    ...
                    <!-- new -->
                                                    ...
                                                    <div class="form-group col-md-6 mb-3">
                                                        <label  class="form-label">Search Type</label>
                                                            <select class="form-select save_side_bar_change" name="cursor_position">
                                                              <option value="0" <?php if (get_setting(company($user['id']),'cursor_position') == '0') {echo 'selected';} ?>>Search bar</option>
                                                              <option value="2" <?php if (get_setting(company($user['id']),'cursor_position') == '2') {echo 'selected';} ?>>Barcode</option>
                                                              <option value="1" <?php if (get_setting(company($user['id']),'cursor_position') == '1') {echo 'selected';} ?>>Product Code</option>
                                                            </select>
                                                    </div>
                                                ...
                                                <div class="form-check ">
                                                    <div class="row mt-2">
                                                        <div class="col-md-3 mb-3">
                                                            <div class="ms-4">
                                                             <input class="form-check-input my-5" type="radio" name="invoice_temp" id="invoice_temp" value="1" checked <?php if ($c_set['invoice_template'] == '1') {echo 'checked';} ?>>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <div class="row mt-2">
                                                        <div class="col-md-6 mb-3">
                                                            <div class="ms-4"> 
                                                                <input class="form-check-input" type="radio" name="receipt_temp" id="receipt_temp" value="1" checked <?php if ($c_set['receipt_template'] == '1') {echo 'checked';} ?>>
                                                                <img src="<?= base_url('public'); ?>/images/rec1.png" style="width: 100px; box-shadow: 0px 1px 2px 1px #0000002b;"> 
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <div class="ms-4">
                                                                <input class="form-check-input" type="radio" name="receipt_temp" id="receipt_temp" value="2" <?php if ($c_set['receipt_template'] == '2') {echo 'checked';} ?>>
                                               ...
                                               <div class="form-group col-md-12">
                                                <button  class="aitsun-primary-btn" name="save_invoice_set"><?= langg(get_setting(company($user['id']),'language'),'Save'); ?></button>
                                               </div>
                                        </div>
                                      </form>
