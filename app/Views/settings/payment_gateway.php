            ...
            <?= csrf_field(); ?>
              <div class="row m-0">
                    ...
                    <div class="form-group mb-2">
                        <label>API Key</label> 
                        <input type="text" oninput="apikeycheck();" class="form-control" required="required" id="api_key" name="api_key" value="<?= get_setting(company($user['id']),'api_key')?>" <?php if (get_setting(company($user['id']),'enable_payment')==1): echo 'disabled'; endif; ?> >
                        <span id="error_msg" style="color: red; font-size: 13px;"></span>
                    </div>
                    
                    <div class="form-group mb-3">
                        <label>Security Key</label> 
                        <input type="text" class="form-control" required="required" id="security_key" name="security_key" value="<?= get_setting(company($user['id']),'security_key')?>" <?php if (get_setting(company($user['id']),'enable_payment')==1): echo 'disabled';endif; ?> >
                    </div>
                    ...
                    <div class="d-flex ">
                        ...
                        <div class="form-check form-switch cursor-pointer ms-5">
                            <input type="checkbox" class="form-check-input" id="enable_payment" name="enable_payment"  value="1" <?php if (get_setting(company($user['id']),'enable_payment')==1): echo 'checked'; endif; ?>>
                        </div>
