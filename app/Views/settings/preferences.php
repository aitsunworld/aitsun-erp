                ...
                <div class="col-md-12 row m-0" >
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        <select name="round_of_value" class="form-control" value="<?= $c_set['round_of_value']; ?>">
                            ...
                            <option value="1" <?php if ($c_set['round_of_value'] == '1') {echo 'selected';} ?>>1.5</option>
                            <option value="2" <?php if ($c_set['round_of_value'] == '2') {echo 'selected';} ?>>1.50</option>
                            <option value="3" <?php if ($c_set['round_of_value'] == '3') {echo 'selected';} ?>>1.500</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        <select class="form-select" name="keyboard" id="input-1">
                            <option value="1" <?php if ($c_set['keyboard'] == '1') {echo 'selected';} ?>>Allow</option>
                            <option value="0" <?php if ($c_set['keyboard'] == '0') {echo 'selected';} ?>>Not Allow</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-4  mb-3">
                        ...
                        <select name="pdf_type" class="form-select" value="<?= $c_set['pdf_type']; ?>"> 
                            ...
                            <option value="dompdf" <?php if ($c_set['pdf_type'] == 'dompdf') {echo 'selected';} ?>>Orginal PDF</option>
                            <option value="image_pdf" <?php if ($c_set['pdf_type'] == 'image_pdf') {echo 'selected';} ?>>Image PDF</option> 
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-3 mb-3 d-none">
                        ...
                        <select type="text" name="billing_style" class="form-select">
                            <option value="0"<?php if (get_setting(company($user['id']),'billing_style')==0) {echo "selected";} ?>><?= langg(get_setting(company($user['id']),'language'),'Grid'); ?></option>
                            <option value="1"<?php if (get_setting(company($user['id']),'billing_style')==1) {echo "selected";} ?>><?= langg(get_setting(company($user['id']),'language'),'Type & Search'); ?></option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select type="text" name="language" class="form-select">
                            ...
                            <option value="<?= $lg; ?>"<?php if (get_setting(company($user['id']),'language')==$lg) {echo "selected";} ?>><?= ucfirst($lg); ?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-3 mb-3 d-none">
                        ...
                        <select type="text" name="subunit_devide" class="form-select">
                            <option value="0" <?php if (get_setting(company($user['id']),'subunit_devide')==0) {echo "selected";} ?>>No</option>
                            <option value="1" <?php if (get_setting(company($user['id']),'subunit_devide')==1) {echo "selected";} ?>>Yes</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="d-flex mb-2">
                            <div class="form-check form-switch cursor-pointer mb-0">
                                <input type="checkbox" class="form-check-input" id="switch-feed" name="switch_feed" value="1" <?php if (get_setting(company($user['id']),'feedback')==1): echo 'checked'; endif; ?>>
                            </div>
                         ...
                         <div class="d-flex mb-2">
                            <div class="form-check form-switch cursor-pointer mb-0">
                                <input type="checkbox" class="form-check-input" id="switch-massenger" name="switch_massenger" value="1" <?php if (get_setting(company($user['id']),'allow_massanger')==1): echo 'checked'; endif; ?>>
                            </div>
                        ...
                        <div class="d-flex mb-2">
                            <div class="form-check form-switch cursor-pointer mb-0">
                                <input type="checkbox" class="form-check-input" id="switch-allow_receipt_date" name="allow_receipt_date" value="1" <?php if (get_setting(company($user['id']),'allow_receipt_date')==1): echo 'checked'; endif; ?>>
                            </div>
                        ...
                        <div class="d-flex mb-2">
                            <div class="form-check form-switch cursor-pointer mb-0">
                                <input type="checkbox" class="form-check-input" id="switch-hide_deleted" name="hide_deleted" value="1" <?php if (get_setting(company($user['id']),'hide_deleted')==1): echo 'checked'; endif; ?>>
                            </div>
                    ...
                    <div class="form-group col-md-12 mb-2 mt-2">
                        <button  class="aitsun-primary-btn" name="save_preference">Save</button>
                    </div>
