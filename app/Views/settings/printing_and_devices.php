                  ...
                  <div class="col-md-12 row m-0" >
                    ...
                    <div class="form-group my-auto col-lg-12 mb-3">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" value="1" <?php if($conf['print_thermal']==1){echo 'checked';} ?> type="checkbox" name="print_thermal" id="print_thermal">
                        </div>
                    </div>
                     ...
                     <div class="form-group col-lg-6 mb-3">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" value="1" <?php if($conf['preview']==1){echo 'checked';} ?> type="checkbox" name="preview" id="preview">
                        </div>
                   </div>
                   ...
                   <div class="form-group  my-auto col-lg-6 mb-3">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" value="1" <?php if($conf['silent']==1){echo 'checked';} ?> type="checkbox" name="silent" id="silent">
                   ...
                   <div class="form-group col-lg-6 col-sm-12 mb-3 ">
                    ...
                    <div class="form-group col-lg-6 col-sm-12 mb-3 ">
                        ...
                        <select class="form_input" name="width">
                            <option value="80mm" <?php if($conf['width']=='80mm'){echo 'selected';} ?>>80mm</option>
                            <option value="78mm" <?php if($conf['width']=='78mm'){echo 'selected';} ?>>78mm</option>
                            <option value="76mm" <?php if($conf['width']=='76mm'){echo 'selected';} ?>>76mm</option>
                            <option value="58mm" <?php if($conf['width']=='58mm'){echo 'selected';} ?>>58mm</option>
                            <option value="57mm" <?php if($conf['width']=='57mm'){echo 'selected';} ?>>57mm</option>
                            <option value="44mm" <?php if($conf['width']=='44mm'){echo 'selected';} ?>>44mm</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-lg-6 mb-3 d-none">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" value="1" <?php if($conf['bar_preview']==1){echo 'checked';} ?> type="checkbox" name="bar_preview" id="bar_preview">
                        </div>
                   </div>
                   ...
                   <div class="form-group col-lg-6 mb-3 d-none">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" value="1" <?php if($conf['bar_silent']==1){echo 'checked';} ?> type="checkbox" name="bar_silent" id="bar_silent">
                   ...
                   <div class="col-lg-12 d-none">
                    ...
                    <div class="form-group col-lg-6 col-md-12  col-sm-12 mb-3 d-none">
                        ...
                        <select class="form_input" name="bar_width">
                            <option value="80mm" <?php if($conf['bar_width']=='80mm'){echo 'selected';} ?>>80mm</option>
                            <option value="78mm" <?php if($conf['bar_width']=='78mm'){echo 'selected';} ?>>78mm</option>
                            <option value="76mm" <?php if($conf['bar_width']=='76mm'){echo 'selected';} ?>>76mm</option>
                            <option value="58mm" <?php if($conf['bar_width']=='58mm'){echo 'selected';} ?>>58mm</option>
                            <option value="57mm" <?php if($conf['bar_width']=='57mm'){echo 'selected';} ?>>57mm</option>
                            <option value="44mm" <?php if($conf['bar_width']=='44mm'){echo 'selected';} ?>>44mm</option>
                        </select> 
                    </div>
                    ...
                    <div class="form-group col-md-12 mb-3">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" value="1" <?php if($conf['weighing_mac']==1){echo 'checked';} ?> type="checkbox" name="weighing_mac" id="weighing_mac">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-12 mb-3">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" value="1" <?php if($conf['fp_device']==1){echo 'checked';} ?> type="checkbox" name="fp_device" id="fp_device">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-12 mb-2">
                      <button  class="aitsun-primary-btn" name="save_devices">Save</button>
                    </div>
                </div>
            </form>
        </div>
