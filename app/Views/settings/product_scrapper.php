...
<div class="main_page_content">
    ...
    <div class="ms-auto">
        <div class="">
            ...
            <div class="modal fade aitsun-model" id="add_site"  aria-hidden="true">
                        ...
                        <form method="post" action="<?= base_url('product_scrapper/add_site') ?>">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12 mt-2">
                                      <button type="submit" class="aitsun-primary-btn" name="save_site">Save site</button>
                                    </div>
...
<!-- scrap -->
    <div class="setting_margin">
        <div class="d-flex justify-content-between ">
            ...
            <div class="text-end">
                <button type="button" class="aitsun-primary-btn-topbar" data-bs-toggle="modal" data-bs-target="#add_site">+ Add Site</button>
            </div>
        </div>
            <hr class="my-1">
                                ...
                                <div class="">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-12 mt-2">
                                          ...
                                          <select class="form-select" name="currency">
                                              <option value="omr" <?php if($st['currency']=='omr'){echo 'selected';} ?>>OMR</option>
                                              <option value="aed" <?php if($st['currency']=='aed'){echo 'selected';} ?>>AED</option>
                                              <option value="usd" <?php if($st['currency']=='usd'){echo 'selected';} ?>>USD</option>
                                              <option value="inr" <?php if($st['currency']=='inr'){echo 'selected';} ?>>INR</option>
                                          </select>
                                        </div>
                                        ...
                                        <div class="form-group col-md-12 mt-2">
                                          ...
                                          <input type="checkbox" name="set_as_default" value="1" <?php if($st['check_default']==1){echo 'checked';} ?>>
                                        </div>

                                        <div class="form-group col-md-12 mt-2 text-end">
                                          <button type="submit" class="aitsun-primary-btn modal_inpu" name="save_site">Save Site</button>
