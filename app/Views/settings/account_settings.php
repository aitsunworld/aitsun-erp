    			...
    			<div class="card">
    				<div class="card-body">
    					...
    					<div class="col-md-12 text-center mb-2 border-bottom pb-2">
							<img src="<?= base_url(); ?>/public/images/avatars/<?php if($user['profile_pic'] != ''){echo $user['profile_pic']; }else{ echo 'avatar-icon.png';} ?>" style="height: 110px;width: 110px; object-fit: contain;" alt="" id="ac_profile" class="rounded-circle p-1 bg-danger">
							<div class="mt-2">
    					...
    					<form action="<?= base_url('settings/changepassword'); ?>/<?= $user['id'] ?>" id="pass_form">
	    					...
	    					<div class="row">
			    				...
			    				<div class="col-md-12 mt-2">
			    					<button class="aitsun-primary-btn w-35" id="change_pass" type="button">Save</button>
			    				</div>
			    			</div>
		    			</form>
    			...
    			<div class="card">
    				<div class="card-body">
    					...
    					<div class="row">
		    					...
		    					<div class="form-group mb-1">
					    			...
					    			<div class="d-flex py-2">
					    				<div class="d-flex me-3">
					    					<input type="radio" class="form-check" name="gender" id="male" value="male"  <?php if($user['gender']=="male"){ echo "checked";}elseif($user['gender']==''){ echo "checked";}?>>
					    					<label class="ms-1 my-auto" for="male">Male</label>
					    				</div>
					    				<div class="d-flex me-3">
					    					<input type="radio" class="form-check" name="gender" id="female" value="female" <?php if($user['gender']=="female"){ echo "checked";}?>>
					    					<label class="ms-1 my-auto" for="female">Female</label>
					    				</div>
					    				<div class="d-flex me-3">
					    					<input type="radio" class="form-check" name="gender" id="others" value="others" <?php if($user['gender']=="others"){ echo "checked";}?>>
		    				...
		    				<div class="col-md-12 mt-2">
		    					<button type="button" id="save_pro" class="aitsun-primary-btn w-25">Save</button>
		    				</div>
		    			</div>
		    			</form>
    				</div>
