        ...
        <div class="col-md-12 row">
            <div class="col-md-6">
                <div class="d-flex justify-content-between">
                    <h6 class="aitsun-fw-bold  my-auto">Category</h6>
                 ...
                 <div class="modal fade" id="caste_cat_add">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form method="post" action="<?= base_url('settings/add_caste_category'); ?>">
                                <?= csrf_field() ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="list-inline mb-0">
                            <?php $i=0; foreach ($student_cat as $stc): $i++; ?>
                            ...
                            <?php endforeach ?>
                            <?php if ($i==0): ?>
                            <li><h6 class="text-danger text-center aitsun-fw-bold p-4">No Category</h6></li>
                            <?php endif ?>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="d-flex justify-content-between">
                    <h6 class="aitsun-fw-bold  my-auto">Sub Category</h6>
                 ...
                 <div class="modal fade" id="caste_subcat_add">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form method="post" action="<?= base_url('settings/add_caste_sub_category'); ?>">
                                <?= csrf_field() ?>
                              <div class="modal-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="list-inline mb-0">
                            <?php $i=0; foreach ($student_sub_cat as $stsub): $i++; ?>
                            <li class="border-bottom py-2">
                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="form-group col-md-12 mb-3">
                                                        <select class="form-select" name="stdcategory" >
                                                            <?php foreach (student_category_array(company($user['id'])) as $scata): ?>
                                                                <option value="<?= $scata['id']; ?>" <?php if ($scata['id']==$stsub['parent_id']) { echo 'selected'; } ?>><?= student_category_name($scata['id']); ?></option>
                                                            <?php endforeach ?>
                                                        </select>
                                                    </div>
                            ...
                            <?php endforeach ?>
                            <?php if ($i==0): ?>
                            <li><h6 class="text-danger text-center aitsun-fw-bold p-4">No Sub Category</h6></li>
                            <?php endif ?>
                        </ul>
                    </div>
                </div>
