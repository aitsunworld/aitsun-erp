                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form  method="post">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="aitsun-primary-btn spinner_btn" name="add_p_subcate">Save Category</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                <button type="submit" class="aitsun-primary-btn" name="edit_p_cate">Save Category</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form  method="post">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                <button type="submit" class="aitsun-primary-btn spinner_btn" name="add_p_seccate">Save Category</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form  method="post">
                                                    ...
                                                    <div class="form-group mb-2 col-md-12">
                                                        ...
                                                        <select class="form-control modal_inpu" name="parent_category" id="input-5" required>
                                                            ...
                                                            <?php foreach (product_categories_array(company($user['id'])) as $ct) { ?>
                                                                <option value="<?= $ct['id']; ?>"<?php if ($sc['parent_id']==$ct['id']) {echo 'selected';} ?>><?= $ct['cat_name']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                <button type="submit" class="aitsun-primary-btn" name="edit_p_subcate">Save Category</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <?= csrf_field(); ?>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select class="form-control modal_inpu" name="parent_category" id="input-5" required>
                                                            ...
                                                            <?php foreach (product_subcategories(company($user['id'])) as $ct) { ?>
                                                              <option value="<?= $ct['id']; ?>"<?php if ($scc['parent_id']==$ct['id']) {echo 'selected';} ?>><?= $ct['sub_cat_name']; ?></option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                <button type="submit" class="aitsun-primary-btn" name="edit_p_seccate">Save Category</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form  method="post">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                <button type="submit" class="aitsun-primary-btn" name="edit_p_brand">Update Brand</button>
                                            </div>
                                        </form>
                                    </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form  method="post">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="aitsun-primary-btn spinner_btn" name="add_p_cate">Save Category</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form  method="post">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="aitsun-primary-btn spinner_btn" name="add_p_brand">Save Brand</button>
                    </div>
                </form>
            </div>
        </div>
