    					...
    					<div class="row">
                           ...
                           <div class="col-md-4 mb-2">
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <select class="form-select" name="country" id="country_select"> 
                                    <?php foreach (countries_array(company($user['id'])) as $ct): ?>
                                       <option <?php if ($company_data['country']==$ct['country_name']) {echo "selected";} ?> value="<?= $ct['country_name'] ?>"><?= $ct['country_name'] ?></option>
                                    <?php endforeach ?>
                                </select>
                                ...
                                <div class="position-relative" id="layerer">
                                    ...
                                    <select class="form-select" name="state" id="state_select_box" required>
                                        ...
                                        <?php foreach (states_array(company($user['id'])) as $st): ?>
                                            <option <?php if ($company_data['state']==$st) {echo "selected";} ?> value="<?= $st ?>"><?= $st ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div>
		    				...
		    				<div class="col-md-12 mt-2">
		    					<button type="button" id="save_org" class="aitsun-primary-btn w-25">Save</button>
		    				</div>
		    			</div>
		    			</form>
    				</div>
