...
<!-- ////////////////////////// TOOL BAR END ///////////////////////// -->
 <div class="modal fade aitsun-modal" id="newyear">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('settings/academic_year'); ?>" method="POST">
                <?= csrf_field() ?>
    ...
    <div class="">
        <div class="m-b-25">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="modal fade aitsun-modal" id="modify<?= $ay['id']; ?>">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalCenterTitle">Add new</h5>
                            ...
                            <form action="<?= base_url('settings/edit_academic_year'); ?>/<?= $ay['id']; ?>" method="POST">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="aitsun-primary-btn btn-sm">Save changes</button>
                                </div>
                            </form>
                        </div>
                    </div>
