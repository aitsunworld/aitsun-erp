        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb aitsun-breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <b class="page_heading text-dark"><?= get_date_format($payroll_data['month'],'M Y') ?></b>
                </li>
            </ol>
        </nav>
...
<div class="toolbar d-flex justify-content-between">
    <div> 
        ...
        <a class="text-dark font-size-footer aitsun-print me-2" data-url="<?= base_url('payroll/get_payroll_slip'); ?>/<?= $payroll_data['id']; ?>/view">
            <i class="bx bx-printer"></i> 
            <span class="hidden-xs"><?= langg(get_setting(company($user['id']),'language'),'Print'); ?></span>
        </a>
        <a class="text-dark font-size-footer me-2 download_complete" href="<?= base_url('payroll/get_payroll_slip'); ?>/<?= $payroll_data['id']; ?>/download"><i class="bx bx-file-blank"></i>  Download PDF</a>
        
<?php if (get_setting(company($user['id']),'pdf_type')=='dompdf' || get_setting(company($user['id']),'pdf_type')==''): ?>
         <a class="text-dark font-size-footer me-2 pdf_open" data-href="<?= base_url('payroll/get_payroll_slip'); ?>/<?= $payroll_data['id']; ?>/view">
...
src="<?= base_url('payroll/get_payroll_slip'); ?>/<?= $payroll_data['id']; ?>/view#toolbar=0&navpanes=0&scrollbar=0" width="900" height="600"/></iframe>
