...
<head>
    ...
    <title>Login - Aitsun aPanel</title>
            ...
            <div class="form_box">
                        ...
                        <?php endif; ?>
                            ...
                            <div class="d-grid gap-2">
                                <button id="log_submit" class="btn g-recaptcha text-white btn_login" data-sitekey="<?= site_key(); ?>" 
                                    <?php if (RECAPTCHA): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        onclick="onSubmit();"
                                    <?php endif ?>
                                    style="background-color: #ce0041d9; border-radius: 5px;">Login</button>
                            </div>
