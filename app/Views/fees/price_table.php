        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb aitsun-breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <b class="page_heading text-dark">Price table</b>
                </li>
            </ol>
        </nav>
...
<div class="main_page_content">
    <div class="aitsun-row"> 
        ...
        <div class="col-md-12 mt-2 pb-5 class_box">
            <h5><?= $cls['class'] ?></h5>
            <div class="aitsun_table table-responsive">
                <table class="erp_table">
                    <thead>
                        <tr>
                            <th scope="col"><a class="text-blue" data-bs-toggle="modal" data-bs-target="#additems" title="Add Items"><i class="bx bx-plus-circle"></i></a> Items</th>
                             <?php $i=0; foreach ($student_cat as $stct): $i++; ?>

                                <th scope="col">
                                    <div class="d-flex justify-content-between">
                                        <div class="my-auto">
                                             <a class="text-primary" data-bs-toggle="modal" data-bs-target="#editcate<?= $stct['id']; ?>"><small><i class="bx bx-pencil mr-1 text-blue"></i></small></a>
                                        <?= $stct['category_name']; ?>
                                     ...
                                     <!-- Modal -->
                                         <div class="aitsun-modal modal fade" id="editcate<?= $stct['id'] ?>">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="post" action="<?= base_url('settings/edit_category'); ?>/<?= $stct['id'] ?>">
                                                            <?= csrf_field() ?>
                                                            <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control" name="stdcategory" value="<?= $stct['category_name'] ?>" placeholder="Student Category " required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-12">
                                                                   ...
                                                                   <a class="btn delete btn-outline-danger" style="border: 1px solid;"  data-url="<?= base_url('fees_and_payments/deletecat'); ?>/<?= $stct['id']; ?>"><i class="bx bx-trash"></i></a>
                                                                </div>
                                                            </div>
                                                        </form>
                         ...
                         <?php $i=0; foreach ($items as $it): $i++; ?>
                          <tr>
                            <td style="min-width: 250px;"><a class="text-primary" data-bs-toggle="modal" data-bs-target="#edititem<?= $it['id']; ?>"><small><i class="bx bx-pencil mr-1 text-blue"></i></small></a>
                                ...
                                <?= $it['product_name'] ?>
                                <?php else : ?>
                                <?= $it['product_name'] ?>(Optional)
                                <?php endif ?>

                                <!-- Modal -->
                                 <div class="aitsun-modal modal fade" id="edititem<?= $it['id']; ?>">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <form method="post" action="<?= base_url('fees_and_payments/edit_items'); ?>/<?= $it['id']; ?>">
                                                    <?= csrf_field() ?>
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <select class="form-control"  name="editable"  required>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                           ...
                                                           <a class="btn delete btn-outline-danger" style="border: 1px solid;" data-url="<?= base_url('fees_and_payments/deleteitem'); ?>/<?= $it['id']; ?>"><i class="bx bx-trash"></i></a>
                                                        </div>
                                                    </div>
                                                </form>
...
<!-- ////////////////////////// MAIN PAGE END ///////////////////////// -->
 ...
 <!-- Modal -->
 <div class="aitsun-modal modal fade" id="addstdcaste">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- Modal -->
 <div class="aitsun-modal modal fade" id="additems">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url('fees_and_payments/add_items'); ?>">
                    <?= csrf_field() ?>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" name="editable"  required>
                                <option value="0">Required For All Students</option>
