        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb aitsun-breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <b class="page_heading text-dark">Transport Fees collected</b>
                </li>
            </ol>
        </nav>
        ...
        <div id="filter" class=" accordion-collapse col-12 border-0 collapse">
            <div class="filter_bar">
                <!-- FILTER -->
                    ...
                    <form method="get" class="d-flex" action="<?= base_url('fees_and_payments/collected_transport_report') ?>">
                        <?= csrf_field(); ?>
        ...
        <div class="aitsun_table col-12 w-100 pt-0 pb-5">
            ...
            <table id="fees_collected_table" class="erp_table sortable">
             <thead>
              ...
              <tbody>
                <?php $i=0; $totalfee=0; foreach ($fees_collected_data as $fc): $i++; ?>
                <tr>
                    <td><?= $i; ?></td>
                    ...
                    <td class="text-right">
                        <?php if ($fc['bill_type']=='receipt' || $fc['bill_type']=='sales' || $fc['bill_type']=='purchase_return'): ?>
                            ...
                            <?php $totalfee+=aitsun_round($fc['amount'],get_setting(company($user['id']),'round_of_value')); ?>
                        <?php else: ?>
                          ---
                          <?php endif ?>
                    </td>
              ...
              <tfoot>
                <tr>
                    ...
                    <th colspan="6" class="text-center"><strong><?= langg(get_setting(company($user['id']),'language'),'Total'); ?></strong></th>
                   
                    <th class="text-right">
                      <strong> <?= aitsun_round($totalfee,get_setting(company($user['id']),'round_of_value')); ?></strong>
                    </th>
                    <th></th>
                </tr>
            </tfoot>
