        ...
        <tr>
          <td style="vertical-align:baseline;width:65%;">
            ...
            <div style="font-size:14px;">
              ...
              <b>Date Issued:</b> <?= get_date_format($invoice_data['invoice_date'],'d M Y'); ?>
               <?php endif ?>
            </div>
            <div style="font-size:14px;">
...
<table style="padding-top: 10px; width: 100%; font-size: 13px;" cellpadding="5" cellspacing="0" class="invoice_font mt-4">
  ...
  <tr style="border:1px solid #cccccc; background: <?= get_setting($invoice_data['company_id'],'Invoice_color'); ?>; color:<?= get_setting($invoice_data['company_id'],'invoice_font_color'); ?>;">
    <td colspan="12" style="text-align:center;">RENTAL DEATILS</td>
  </tr>

  <tr  style="border:1px solid #cccccc; background: <?= get_setting($invoice_data['company_id'],'Invoice_color'); ?>; color:<?= get_setting($invoice_data['company_id'],'invoice_font_color'); ?>;">
    <td style="border:1px solid #cccccc;"><b><?= langg(get_setting($invoice_data['company_id'],'language'),'Rental From'); ?></b></td>
    <td style=" text-align:center;border:1px solid #cccccc;"><b><?= langg(get_setting($invoice_data['company_id'],'language'),'Rental To'); ?>. </b></td>
