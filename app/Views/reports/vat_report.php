    ...
    <div class="right_bar d-flex justify-content-between w-100">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb aitsun-breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <b class="page_heading text-dark">VAT Report</b>
                </li>
            </ol>
        </nav>
                ...
                <!-- FILTER -->
                  <form method="get" class="d-flex">
                    <?= csrf_field(); ?>
                      ...
                      <a class=" btn-outline-dark btn btn-sm" href="<?= base_url('vat_report') ?>"><?= langg(get_setting(company($user['id']),'language'),'Clear'); ?></a>
...
<div class="sub_main_page_content">
    <div class="aitsun-row "> 
        ...
        <div class="aitsun_table table-responsive col-12 w-100 pt-0 pb-5">
            ...
            <table id="gst_table" class="erp_table sortable">
             <thead>
                ...
                <tr>
                    ...
                    <th class="sorticon" style="min-width: 100px;">VATIN</th>
            ...
            <?php  $data_count=0; ?>
            <?php $grand_sub_total=0;$grand_ta_total=0;$grand_total=0; $grand_round_total=0; $grand_rounded_total=0; foreach ($vat_reports as $db) { $data_count++; ?> 
              <tbody>
              ...
              <?php if ($data_count<1): ?>
                    <tr>
                        <td class="text-center" colspan="12">
                            <span class="text-danger">No VAT Report</span>
                        </td>
                    </tr>
                <?php endif ?> 
                 <tfoot>
