        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb aitsun-breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <b class="page_heading text-dark">Bank Book</b>
                </li>
            </ol>
        </nav>
...
<div class="toolbar d-flex justify-content-between">
    <div>
        <a href="javascript:void(0);" class="aitsun_table_export text-dark font-size-footer me-2" data-type="excel" data-table="#bank_book_table" data-filename="Bank book <?= str_replace(array('From','To','&nbsp;','Today','Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','day'), '', $report_date); ?>"> 
            <span class="my-auto">Excel</span>
        </a>
        <a href="javascript:void(0);" class="aitsun_table_export text-dark font-size-footer me-2" data-type="csv" data-table="#bank_book_table" data-filename="Bank book <?= str_replace(array('From','To','&nbsp;','Today','Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','day'), '', $report_date); ?>"> 
            <span class="my-auto">CSV</span>
        </a>
        <a href="javascript:void(0);" class="aitsun_table_export text-dark font-size-footer me-2" data-type="pdf" data-table="#bank_book_table" data-filename="Bank book <?= str_replace(array('From','To','&nbsp;','Today','Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','day'), '', $report_date); ?>"> 
        ...
        <a href="javascript:void(0);" class="aitsun_table_quick_search text-dark font-size-footer me-2" data-table="#bank_book_table"> 
        ...
        <div class="filter_bar">
            ...
            <form method="get" class="d-flex">
               ...
               <input type="date" name="from" class="form-control form-control-sm filter-control" title="From" placeholder="">
                ...
                <a class=" btn-outline-dark btn btn-sm" href="<?= base_url('bank_book') ?>"><?= langg(get_setting(company($user['id']),'language'),'Clear'); ?></a>
...
<div class="sub_main_page_content ">
    <div class="aitsun-row pb-5">
        ...
        <div class="aitsun_table w-100 pt-0">
            ...
            <table id="bank_book_table" class="erp_table sortable no-wrap">
                 <thead>
