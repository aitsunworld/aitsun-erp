        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb aitsun-breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <b class="page_heading text-dark">User wise Report</b>
                </li>
            </ol>
        </nav>
...
<div class="toolbar d-flex justify-content-between">
    <div>
        <a href="javascript:void(0);" class="aitsun_table_export text-dark font-size-footer me-2" data-type="excel" data-table="#userwise_report" data-filename="User wise report <?= str_replace(array('From','To','&nbsp;','Today','Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','day'), '', $report_date); ?>"> 
            <span class="my-auto">Excel</span>
        </a>
        <a href="javascript:void(0);" class="aitsun_table_export text-dark font-size-footer me-2" data-type="csv" data-table="#userwise_report" data-filename="User wise report <?= str_replace(array('From','To','&nbsp;','Today','Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','day'), '', $report_date); ?>"> 
            <span class="my-auto">CSV</span>
        </a>
        <a href="javascript:void(0);" class="aitsun_table_export text-dark font-size-footer me-2" data-type="pdf" data-table="#userwise_report" data-filename="User wise report <?= str_replace(array('From','To','&nbsp;','Today','Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','day'), '', $report_date); ?>"> 
        ...
        <a href="javascript:void(0);" class="aitsun_table_quick_search text-dark font-size-footer me-2" data-table="#userwise_report"> 
    ...
    <div id="filter" class=" accordion-collapse col-12 border-0 collapse">
        <div class="filter_bar">
            <!-- FILTER -->
              ...
              <a class=" btn-outline-dark btn btn-sm" href="<?= base_url('user_wise_report') ?>"><?= langg(get_setting(company($user['id']),'language'),'Clear'); ?></a>
              </form>
...
<div class="sub_main_page_content ">
    <div class="aitsun-row pb-5">
        ...
        <div class="aitsun_table w-100 pt-0">
            ...
            <table id="userwise_report" class="erp_table sortable">
                 <thead>
                 ...
                 <tbody>
                    <?php  $data_count=0; $coll=''; ?>
                    <?php foreach ($day_book_data as $db) { $data_count++; $tcoll=$db['collected_by']; ?>


                     <?php if ($data_count==1){$coll=$db['collected_by'];} ?>

                    <?php if ($coll!=$tcoll || $data_count==1): $coll=$db['collected_by']; ?>
                        <?php if ($db['collected_by']>0): ?>
                            <tr>
                                <td colspan="7" class="bg-grey bg-invoice text-center text-white">
                                    <b><?= user_name($db['collected_by']) ?></b>
                                </td>
                            </tr>
                        <?php endif ?> 
                    <?php endif ?>
                        ...
                        <tr>
                          ...
                          <td><?= get_date_format($db['datetime'],'d-m-Y - h:i a'); ?></td>
                          <td>
