...
<div class="toolbar d-flex justify-content-between">
    <div class="d-flex">
        ...
        <a href="<?= base_url('parties_category') ?>" class="href_loader text-dark my-auto font-size-footer me-2"><i class="bx bx-home"></i> <span class="my-auto">Appointments</span></a>
